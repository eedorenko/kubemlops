...
echo $model_id
az ml model deploy -n $DEPLOYMENT_NAME -m $model_id --ic '/scripts/inferenceconfig.json'  --dc '/scripts/deploymentconfig.json' -w $WORKSPACE -g $RESOURCE_GROUP --overwrite -v
